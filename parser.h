...
public:
	...
	/* */
private:
	Node* next;   //蟈諉狟珨跺誹萸ㄛ佼唗睿nodeList笢腔佼唗悵厥珨祡
	int nodeNum, conCount; //nodeNum 桶尨nodeList笢誹萸腔晤瘍 植1羲宎ㄛconCount桶尨蜆誹萸蟈諉腔晚杅
	Connections* conList;
	int nameNum; //蚚誧勤誹萸腔晤瘍佼唗
};
